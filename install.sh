...
sed -i '/^bar {/,/^}/d' "$H/.config/sway/config"
...
curl -sL https://raw.githubusercontent.com/nabaraj-bhandari/archinstall/main/wallpaper.jpg -o "$H/.config/wallpaper.jpg"

mkdir -p "$H/Pictures" "$H/Downloads" "$H/Projects"

arch-chroot /mnt chown -R "$USERNAME:$USERNAME" "/home/$USERNAME"
arch-chroot /mnt systemctl --user --global enable pipewire pipewire-pulse wireplumber
